...
#SBATCH -J L1000N1800_HYDRO_FIDUCIAL-reduced-snapshots
...
snapdir="/cosma8/data/dp004/flamingo/Runs/L1000N1800/HYDRO_FIDUCIAL/snapshots"
# folder where the SOAP files are stored
soapdir="/snap8/scratch/dp004/dc-mcgi1/reduce_snapshots/L1000N1800/HYDRO_FIDUCIAL/SOAP/VR"
# output folder for the reduced snapshot
outdir="/snap8/scratch/dp004/dc-mcgi1/reduce_snapshots/L1000N1800/HYDRO_FIDUCIAL/pr_snapshots_reduced"
...
# so 64 is the maximum for an L1000N1800 hydro run
